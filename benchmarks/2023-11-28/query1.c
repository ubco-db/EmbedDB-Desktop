...
embedDBOperator* createOperator(embedDBState* state, void*** allocatedValues) {
    embedDBIterator* it = malloc(sizeof(embedDBIterator));
    it->minKey = NULL;
    it->maxKey = NULL;
    it->minData = NULL;
    it->maxData = NULL;
    ...
    embedDBAggregateFunc* group = calloc(1, sizeof(embedDBAggregateFunc));
    ...
    embedDBAggregateFunc* aggFuncs = malloc(4 * sizeof(embedDBAggregateFunc));
    aggFuncs[0] = *group;
    aggFuncs[1] = *MINC2;
    aggFuncs[2] = *MAXC3;
    aggFuncs[3] = *avg3;
    ...
    *allocatedValues = malloc(2 * sizeof(void*));
