...
int main() {
    ...
    for (int run = 0; run < numRuns; run++) {
        ...
        char const selectStarSmallResult[] = "SELECT * FROM keyValue WHERE key >= 104449;";
        ...
        char const selectStarLargeResult[] = "SELECT * FROM keyValue WHERE key >= 21989;";
        ...
        numRecords = 0;
        char const selectDataSingleResult[] = "SELECT * FROM keyValue WHERE attr3 = 214517;";
        ...
        numRecords = 0;
        char const selectDataSmallResultInt[] = "SELECT * FROM keyValue WHERE attr3 >= 350000;";
        ...
        numRecords = 0;
        char const selectDataLargeResultInt[] = "SELECT * FROM keyValue WHERE attr3 >= 149000;";
        ...
        numRecords = 0;
        char const selectKeyDataResultInt[] = "SELECT * FROM keyValue WHERE key >= 43978 AND attr3 >= 149000 AND attr3 <= 215000;";
...
int createTableIntIntIntInt() {
    ...
    char const createStatement[] = "CREATE TABLE keyValue (key INTEGER PRIMARY KEY, attr1 INTEGER, attr2 INTEGER, attr3 INTEGER);";
