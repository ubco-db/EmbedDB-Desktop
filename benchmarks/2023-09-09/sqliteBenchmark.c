...
int main() {
    ...
    for (int run = 0; run < numRuns; run++) {
        ...
        //////////////////////////////////
        // SELECT 5% (key >= 952425684) //
        //////////////////////////////////
        numRecords = 0;

        timeSelectStarSmallResultInt[run] = clock();

        char const selectStarSmallResult[] = "SELECT * FROM keyValue WHERE key >= 952425684;";
        ...
        char const selectStarLargeResult[] = "SELECT * FROM keyValue WHERE key >= 947916144;";
        ...
        numRecords = 0;
        char const selectDataSingleResult[] = "SELECT * FROM keyValue WHERE airTemp = 600;";
        ...
        numRecords = 0;
        char const selectDataSmallResultInt[] = "SELECT * FROM keyValue WHERE airTemp >= 600;";
