...
void sbits_variable_data_reloads_with_one_hundred_six_pages_of_data_correctly() {
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(772, state->minVarRecordId, "SBITS minVarRecordId did not have the correct value after initializing variable data from a file with one page of records.");
